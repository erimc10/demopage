                ...
                >
                  <template slot="body">
                    ...
                    <ul>
                      ...
                      <li>
                        <div class="d-flex align-items-center">
                          <div class="text-left w-50">Domains:</div>
                          <div class="text-left w-75">
                      ...
                      <li>
                        <div class="d-flex align-items-center">
                          <div class="text-left w-50">Team size:</div>
                          <div class="text-left w-75">
                      ...
                      <li>
                        <div class="d-flex align-items-center">
                          <div class="text-left w-50">Tech Support:</div>
                          <div class="text-left w-75">
                      ...
                      <li>
                        <div class="d-flex align-items-center">
                          <div class="text-left w-50">Free Updates:</div>
                          <div class="text-left w-75">
                            <span class="pl-2 text-sm ml-3">6 months</span>
                          </div>
                        </div>
